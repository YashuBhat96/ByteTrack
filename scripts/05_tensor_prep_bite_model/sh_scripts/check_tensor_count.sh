...
PYTHON_SCRIPT='/storage/group/klk37/default/homebytes/code/scripts/05_tensor_prep_bite_model/05_03_tensor_label_count.py'
...
python $PYTHON_SCRIPT >> /storage/home/ybr5070/group/homebytes/code/scripts/logs/tensor_label_count_all_new.log 2>&1
