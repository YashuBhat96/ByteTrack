...
def process_single_excel_file(excel_file, root_image_dir, sequence_length, checkpoint_dir):
    try:
        ...
        # Extract features using EfficientNet only for the downsampled sequences
...
# Main function with ThreadPoolExecutor for parallel processing, using 12 workers
def process_all_parallel(root_excel_dir, root_image_dir, output_folder, sequence_length=50, num_workers=8):
...
if __name__ == '__main__':
    root_excel_dir = '/storage/group/klk37/default/homebytes/video/fbs/labels_4/train_1'
    root_image_dir = '/storage/group/klk37/default/homebytes/video/fbs/FRCNN+yolo/train_1'
    output_folder = '/storage/group/klk37/default/homebytes/video/fbs/tensors_train_lstm_new_1'

    # Process all Excel files and corresponding image folders in parallel with 12 workers
    process_all_parallel(root_excel_dir, root_image_dir, output_folder, sequence_length=50, num_workers=8)
