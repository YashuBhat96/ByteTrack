...
def process_excel_file(excel_file, root_image_dir, sequence_length=50, batch_size=24, num_workers=8):
    ...
    output_file = f"/storage/group/klk37/default/homebytes/video/fbs/train_new/{os.path.splitext(os.path.basename(excel_file))[0]}_sequences.pt"
    torch.save({
...
if __name__ == '__main__':
    root_excel_dir = '/storage/group/klk37/default/homebytes/video/fbs/labels_3/train'
    root_image_dir = '/storage/group/klk37/default/homebytes/video/fbs/FRCNN+yolo/train'
