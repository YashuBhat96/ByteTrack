...
PYTHON_SCRIPT='/storage/group/klk37/default/homebytes/code/scripts/05_tensor_prep_bite_model/05_01_tensor_prep/test_t.py'
...
python $PYTHON_SCRIPT >> /storage/home/ybr5070/group/homebytes/code/scripts/logs/tensor_prep_test_misc_new.log 2>&1
