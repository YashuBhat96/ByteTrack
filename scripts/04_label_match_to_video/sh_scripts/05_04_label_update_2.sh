...
#SBATCH --mem=250GB              # Total memory for the job
...
PYTHON_SCRIPT="/storage/group/klk37/default/homebytes/code/scripts/04_label_match_to_video/04_04_label_update2.py"
...
python $PYTHON_SCRIPT >> /storage/home/ybr5070/group/homebytes/code/scripts/logs/lab_upd3_test_val_misc.log 2>&1
