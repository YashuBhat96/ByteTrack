...
PYTHON_SCRIPT="/storage/group/klk37/default/homebytes/code/scripts/04_label_match_to_video/label_update3.py"
...
python $PYTHON_SCRIPT >> /storage/home/ybr5070/group/homebytes/code/scripts/logs/label_seq_update.log 2>&1
