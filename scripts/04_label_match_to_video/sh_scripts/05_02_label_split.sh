...
PYTHON_SCRIPT="/storage/group/klk37/default/homebytes/code/scripts/05_label_match_to_video/05_02_label_split.py"
...
python $PYTHON_SCRIPT >> /storage/home/ybr5070/group/homebytes/code/scripts/logs/split_labels.log 2>&1
