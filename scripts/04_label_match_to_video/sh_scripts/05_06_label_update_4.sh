...
PYTHON_SCRIPT="/storage/group/klk37/default/homebytes/code/scripts/04_label_match_to_video/04_06_label_update4.py"
...
python $PYTHON_SCRIPT >> /storage/home/ybr5070/group/homebytes/code/scripts/logs/label4_update_misc.log 2>&1
