...
PYTHON_SCRIPT="/storage/group/klk37/default/homebytes/code/scripts/04_label_match_to_video/04_03_label_update1.py"
...
python $PYTHON_SCRIPT >> /storage/home/ybr5070/group/homebytes/code/scripts/logs/lab_upd1_new_misc.log 2>&1
