...
PYTHON_SCRIPT="/storage/home/ybr5070/group/homebytes/code/scripts/06_LSTM_train/grid_search_1.py"
...
python $PYTHON_SCRIPT >> /storage/home/ybr5070/group/homebytes/code/scripts/logs/train_grid11.log 2>&1
