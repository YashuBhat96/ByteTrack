...
PYTHON_SCRIPT="/storage/group/klk37/default/homebytes/code/scripts/08_LSTM_train/test_eval.py"
...
python $PYTHON_SCRIPT >> /storage/home/ybr5070/group/homebytes/code/scripts/logs/evaluate_lstm_test.log 2>&1
