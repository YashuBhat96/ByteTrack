...
PYTHON_SCRIPT="/storage/group/klk37/default/homebytes/code/scripts/06_LSTM_train/06_01_lstm_cv.py"
...
python $PYTHON_SCRIPT >>  /storage/home/ybr5070/group/homebytes/code/scripts/logs/train_cv_latest_1.log 2>&1
