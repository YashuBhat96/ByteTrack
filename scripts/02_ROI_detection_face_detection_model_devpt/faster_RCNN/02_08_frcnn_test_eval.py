...
if __name__ == '__main__':
    ...
    val_dataset = FaceDataset('/storage/group/klk37/default/homebytes/video/fbs/split_resized/test', transform=transform)
    ...
    # Load ground truths
    ground_truths = get_ground_truths('/storage/group/klk37/default/homebytes/video/fbs/split_resized/test')
