...
PYTHON_SCRIPT='/storage/group/klk37/default/homebytes/code/scripts/val_eval_fcnn.py'
...
python $PYTHON_SCRIPT >> /storage/home/ybr5070/group/homebytes/code/scripts/logs/frcnn_val_eval.log 2>&1
