...
PYTHON_SCRIPT='/storage/group/klk37/default/homebytes/code/scripts/02_ROI_detection_face_detection_model_devpt/faster_RCNN/02_11_frcnn_map.py'
...
python $PYTHON_SCRIPT >> /storage/home/ybr5070/group/homebytes/code/scripts/logs/frcnn_test_eval_map.log 2>&1
